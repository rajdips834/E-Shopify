    ...
    <Layout>
      ...
      >
        ...
        <div className="justify-center max-w-5xl px-6 mx-auto md:flex md:space-x-6 xl:px-0 ">
          <div className="my-auto rounded-lg md:w-2/3 ">
            {cartItems.map((item, index) => {
              if (
                cartItems[index + 1] &&
                cartItems[index + 1].image == item.image
              ) {
                return;
              } else {
                  ...
                  >
                    ...
                    <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                      ...
                      <div
                        ...
                        className="flex justify-between mt-4 sm:space-y-6 sm:mt-0 sm:block sm:space-x-6"
                      >
                        <svg
